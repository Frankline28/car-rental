...
function SheetTrigger({ asChild = false, children, ...props }: React.ComponentPropsWithoutRef<typeof SheetPrimitive.Trigger> & { asChild?: boolean }) {
...
function SheetContent({
  ...
  ...props
}: React.ComponentPropsWithoutRef<typeof SheetPrimitive.Popup> & { side?: "top" | "bottom" | "left" | "right"; showCloseButton?: boolean }) {
  return (
    <SheetPortal>
      <SheetOverlay />
