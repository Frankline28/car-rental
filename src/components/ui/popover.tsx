...
function PopoverTrigger({ asChild = false, children, ...props }: React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Trigger> & { asChild?: boolean }) {
...
function PopoverContent({
  ...
  sideOffset = 4,
  ...props
}: React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Popup> & { align?: any; alignOffset?: number; side?: any; sideOffset?: number }) {
  return (
